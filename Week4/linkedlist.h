...
// convenience macros
/**
 * @brief   Assign this to your stack allocated XOR_LL object to initialize it
 *
 */
...
/**
 * @brief   Convenience macro for traversing the Loop in Head to Tail direction
 *          Also resets/initializes the iterator at the start of the loop
 *
 */
 ...
 *                  XOR_LL_STATUS_FAILURE_ALLOC - allocation failure
 */
int xor_ll_push_head(XOR_LL *ll_ptr, const void *data, size_t size);

...
typedef struct rbnode {
  ...
  struct rbnode *link[2]; /* Left (0) and right (1) links */
} rbnode_t;
...
struct rbtrav {
  ...
  rbnode_t *path[HEIGHT_LIMIT]; /* Traversal path */
...
*/
static int is_red ( rbnode_t *root ) {
...
/**
  ...
  <remarks>For rbtree.c internal use only</remarks>
*/
static rbnode_t *rb_single ( rbnode_t *root, int dir ) {
...
/**
  ...
  <remarks>For rbtree.c internal use only</remarks>
*/
static rbnode_t *rb_double ( rbnode_t *root, int dir ) {
...
*/
static rbnode_t *new_node ( rbtree_t *tree, void *data ) {
  rbnode_t *rn = (rbnode_t *)malloc ( sizeof *rn );
...
/**
  ...
  <remarks>
  The returned pointer must be released with rbdelete
  </remarks>
*/
rbtree_t *rbnew ( cmp_f cmp, dup_f dup, rel_f rel ) {
  rbtree_t *rt = (rbtree_t *)malloc ( sizeof *rt );
...
/**
  ...
  <remarks>
  The tree must have been created using rbnew
  </remarks>
*/
...
/**
  ...
  rbtfirst or rbtlast are called.
  The pointer must be released with rbtdelete
  </remarks>
*/
rbtrav_t *rbtnew ( void ) {
  return (rbtrav_t*)malloc ( sizeof ( rbtrav_t ) );
}
...
/**
  ...
  <remarks>
  The object must have been created with rbtnew
  </remarks>
*/
...
/**
  ...
  <remarks>For rbtree.c internal use only</remarks>
*/
static void *start ( rbtrav_t *trav, rbtree_t *tree, int dir ) {
  trav->tree = tree;
  trav->it = tree->root;
  trav->top = 0;
...
/**
  ...
  <remarks>For rbtree.c internal use only</remarks>
*/
static void *move ( rbtrav_t *trav, int dir ) {
